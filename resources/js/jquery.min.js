/*! jQuery v3.6.3 | (c) OpenJS Foundation and other contributors | jquery.org/license */ !(function(e, t) {
                        ...
                        return (
                            ...
                            ((a = (C = r).documentElement),
                                ...
                                (d.getById = ce(function(e) {
                                    return (
                                        (a.appendChild(e).id = E), !C.getElementsByName ||
    ...
    E.fn.extend({
        ...
        is: function(e) {
            return !!j(
                this,
                "string" == typeof e && k.test(e) ? E(e) : e || [], !1
            ).length;
        },
    });
    var D,
    ...
    function He(n, r, i, o) {
        ...
        if (
            ...
            if (s)
                for (
                    l = a[a.length - 1].ownerDocument, E.map(a, qe), c = 0; c < s; c++
                )
                    (u = a[c]),
                    he.test(u.type || "") &&
    ...
    E.extend({
            ...
            clone: function(e, t, n) {
                ...
                if (t)
                    if (n)
                        for (
                            o = o || ye(e), a = a || ye(c), r = 0, i = o.length; r < i; r++
                        )
                            Le(o[r], a[r]);
                    else Le(e, c);
                return (
            ...
            cleanData: function(e) {
                for (
                    var t, n, r, i = E.event.special, o = 0; void 0 !== (n = e[o]); o++
                )
                    if (V(n)) {
                        if ((t = n[Y.expando])) {
                            if (t.events)
        ...
        E.each({
            ...
            function(e, a) {
                E.fn[e] = function(e) {
                    for (
                        var t, n = [], r = E(e), i = r.length - 1, o = 0; o <= i; o++
                    )
    ...
    function ft(o, e, t) {
        var n,
            ...
            l = s.promise({
                elem: o,
                props: E.extend({}, e),
                opts: E.extend(!0, { specialEasing: {}, easing: E.easing._default },
                    t
                ),
