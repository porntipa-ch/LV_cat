                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" id="trip_name"  name="trip_name" class="form-control"
                                                placeholder="ชื่อโปรแกรม" name="trip_name" />
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-1">
                                            <label class="form-label" for="start_date">วันเริ่มทริป</label>
                                            <input type="date" id="start_date" name="start_date" class="form-control" name="trip_name" />
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-1">
                                            <label class="form-label" for="end_date">วันจบทริป</label>
                                            <input type="date" id="end_date" name="end_date" class="form-control" name="trip_name" />
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-1">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1">
                                            ...
                                            <textarea class="form-control" id="guide_name" name="guide_name" rows="3" placeholder="รายละเอียดเพิ่มเติม"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="mb-1">
                                            <label class="form-label" for="hotel">โรงแรม</label>
                                            <textarea class="form-control" id="hotel" name="hotel" rows="3" placeholder="รายละเอียดโรงแรม"></textarea>
                                        </div>
                                    </div>
                                    <!-- Button -->
