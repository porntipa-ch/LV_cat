                        ...
                        <table class="table-bordered text-center" style="border:solid 1px black">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type="number" class="form-control" placeholder="ราคาต่อหน่วย" /></td>
                                    <td><input type="number" class="form-control" placeholder="จำนวนเงิน" /></td>
                                    <td><i data-feather="x-square" class="cursor-pointer font-medium-3" data-repeater-delete></i></td>
                                </tr>
                                <tr>
                                    <td colspan="6">
                                        <div>
                                            <div class="px-1 py-1" style="display: flex;justify-content: right; flex-wrap: nowrap;width: 100%;">
                                ...
                                <tr>
                                    <td colspan="4">
                                        <p><span class="text-danger">*หมายเหตุ*</span>อัตราค่าบริการนี้ไม่รวมค่าใช้จ่ายที่เกิดขึ้นเพิ่มเติมนอกเหนือข้อตกลงที่คุยกันไว้
...
@section('page-script')
<script src="{{ asset('js/scripts/pages/app-quotaion.js') }}"></script>
@endsection