    ...
    <ul class="nav navbar-nav align-items-center ms-auto">
        <li class="nav-item dropdown dropdown-language">
            <a class="nav-link dropdown-toggle" id="dropdown-flag" href="#" data-bs-toggle="dropdown"
                ...
                <span class="selected-language">ภาษาไทย</span>
            </a>
            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-flag">
                <a class="dropdown-item" href="{{ url('lang/th') }}" data-language="th">
                    <i class="flag-icon flag-icon-th"></i> ภาษาไทย
                </a>
        ...
        <li class="nav-item dropdown dropdown-user">
            ...
            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                <h6 class="dropdown-header">จัดการบัญชี</h6>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#">
                    <i class="me-50" data-feather="user"></i> โปรไฟล์
                </a>
                <a class="dropdown-item"
                    href="{{ Route::has('profile.show') ? route('profile.show') : 'javascript:void(0)' }}">
                    <i class="me-50" data-feather="settings"></i> ตั้งค่า
                </a>
                ...
                @if (Auth::check())
                    <a class="dropdown-item" href="{{ route('logout') }}"
                        ...
                        <i class="me-50" data-feather="power"></i> ออกจากระบบ
                    </a>
